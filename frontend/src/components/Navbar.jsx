  ...
  const handleEmotionSearch = async (query) => {
    try {
      ...
      navigate(
        `/search?query=${encodeURIComponent(
          query
        )}&filter_by=emotion&results=${encodeURIComponent(
          JSON.stringify(data)
        )}`
      );
    } catch (err) {
      ...
      <div className="nav-center">
        <div className="search-group">
          ...
          <div className="search-filter-wrapper" ref={dropdownRef}>
            ...
            <div
              className={`search-filter-dropdown ${showDropdown ? "show" : ""}`}
            >
      ...
      <div className="nav-right">
        ...
        >
          ...
          <div className={`dropdown-menu ${showMenu ? "show" : ""}`}>
            ...
            <button className="button" onClick={() => navigate("/setting")}>
              Setting
            </button>
            {roles.includes("admin") && (
              <button className="button" onClick={() => navigate("/database")}>
                Database
              </button>
            )}
          </div>
